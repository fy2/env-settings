...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@wimbledon\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}\u@wimbledon:\w\$ '
fi
...
case "$TERM" in
xterm*|rxvt*)
    PS1="\[\e]0;${debian_chroot:+($debian_chroot)}\u@wimbledon: \w\a\]$PS1"
    ;;
*)
    ;;
esac
...
PATH=$PATH:/home/feyruz/perl5/bin
PATH=$PATH:/home/feyruz/bin
